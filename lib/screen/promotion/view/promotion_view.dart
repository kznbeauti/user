  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Center(child: Text("Promotion View",style:appBarTitleStyle)),
        ),
        body: Padding(
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          ...
                          title: Text(promotion.code,style: TextStyle(
                            color: Colors.black,
                            fontSize: 20,
                            fontWeight: FontWeight.bold,
                          )),
                          trailing: Text("${promotion.promotionValue}ks",style: TextStyle(
                            color: Colors.black,
                            fontSize: 18,
                          )),
                        );
