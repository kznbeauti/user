...
class _PromotionManagerState extends State<PromotionManager> {
  ...
  void initState() {
    input = Input(input: {
      ...
      "promotionValue": TextEditingController()..text = "${widget.promotion?.promotionValue ?? ""}",
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: const Center(child: Text("Promotion Form",style: appBarTitleStyle,)),
          actions: [
            ...
            child: ElevatedButton(
              ...
              onPressed: () => _homeController.addPromotion(
                Promotion(
                  ...
                  promotionValue: int.parse(input.input["promotionValue"]?.value.text ?? "0"),
